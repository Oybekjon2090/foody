...
class ProductController extends ChangeNotifier {
  ...
  createProduct(
    ...
    await firestore.collection("products").add(ProductModel(
            name: name,
            desc: desc,
            image:  ProductController().getCategory(),
  ...
  addCategory({required String name,required String image,required VoidCallback onSuccess}) async {
    await firestore.collection("category").add({"name": name, 'image': image});
    onSuccess();
  }
